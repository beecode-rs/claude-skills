...
1. **File placement** — business logic in `src/business/`, data access in `src/dal/`, handlers in `src/controller/`, utilities in `src/util/`; no arbitrary top-level folders
